...
```shell
examples-ipc-app posix msq -s -n /test
```

Start the client:

```shell
examples-ipc-app posix msq -n /test -c 15
```
...
```shell
examples-ipc-app posix msq --clean -n /test
```
...
```shell
examples-ipc-app posix shm -s -n /test
```
...
```shell
examples-ipc-app posix shm -n /test
```
...
```shell
examples-ipc-app posix shm --clean -n /test
```
...
```shell
examples-ipc-app posix sem -s -n /test
```
...
```shell
examples-ipc-app posix sem -n /test
```
...
```shell
examples-ipc-app posix sem -n /test -r
```
...
```shell
examples-ipc-app sysv msq -s -k 200
```

Start the client:

```shell
examples-ipc-app sysv msq -k 200 -c 15
```

To delete a SystemV message queue:

```shell
examples-ipc-app sysv msq --clean -k 200
```
...
```shell
examples-ipc-app sysv shm -s -k 200
```

Start the client:

```shell
examples-ipc-app sysv shm -k 200
```

To delete a SystemV shared memory:

```shell
examples-ipc-app sysv shm --clean -k 200
```
...
```shell
examples-ipc-app sysv sem -s -k 200
```

Run the client:

```shell
examples-ipc-app sysv sem -k 200
