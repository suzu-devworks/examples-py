...
```console
$ pyenv virtualenv 3.7.3 3.7.3-myenv

Looking in links: /tmp/tmp40k9ceag
Requirement already satisfied: setuptools in /home/xxxxxx/.anyenv/envs/pyenv/versions/3.7.3/envs/3.7.3-myenv/lib/python3.7/site-packages (40.8.0)
Requirement already satisfied: pip in /home/xxxxxx/.anyenv/envs/pyenv/versions/3.7.3/envs/3.7.3-myenv/lib/python3.7/site-packages (19.0.3)
...
```console
$ pyenv activate 3.7.3-myenv

pyenv-virtualenv: prompt changing will be removed from future release. configure `export PYENV_VIRTUALENV_DISABLE_PROMPT=1' to simulate the behavior.

(3.7.3-myenv) $ python --version

Python 3.7.3

(3.7.3-myenv) $ pyenv deactivate
$ python --version
