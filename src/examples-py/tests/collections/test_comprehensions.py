"""
This test to learn collection comprehensions.

The notation is very difficult to read and understand for non-Python programmers, but if you are told that the speed is different, you will want to write it that way.
...
class TestComprehensions:
    ...
    def test_nested_list_comprehensions(self):
        ...
        # use zip:
        ziped = [[x, y, z] for x, y, z in zip(*matrix)]
        assert ziped == [[1, 5, 9], [2, 6, 10], [3, 7, 11], [4, 8, 12]]
    ...
    def test_dictionary_mergeing(self):
        ...
        # use operator **
        merged = {**dict1, **dict2}
        assert merged == {"KEY1": 1, "KEY2": "string1", "KEY3": 3, "KEY4": "string2", "KEY5": 5, "KEY6": "string3"}
    ...
    def test_dictionary_key_matching(self):
        ...
        assert dict3 == {"KEY1": None, "KEY2": "string1", "KEY3": None, "KEY4": "string2", "KEY5": None}
        ...
        assert dict4 == {"KEY1": 1, "KEY2": "string1", "KEY3": 3, "KEY4": "string2", "KEY5": 5}
