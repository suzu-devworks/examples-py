...
def test_basic_special_method_context() -> None:
...
def test_inherited_manager_context() -> None:
...
def test_contextmanager_decorator_context() -> None:
    ...
    def acquire_resource(*args: Any, **kwds: Any) -> Resource:
        return Resource()

    @contextmanager
    def managed_resource(*args: Any, **kwds: Any) -> Generator[Resource, Any, None]:
...
@pytest.mark.asyncio
async def test_async_special_method_context() -> None:
    """Implement two methods
...
@pytest.mark.asyncio
async def test_asynccontextmanager_decorator_context() -> None:
    from contextlib import asynccontextmanager

    async def acquire_resource_async() -> Resource:
        await asyncio.sleep(0)
        return Resource()

    @asynccontextmanager
    async def managed_resource_async() -> AsyncGenerator[Resource, None]:
